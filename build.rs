...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	config
		...
		.type_attribute("BlockV5", SERDE_ANNOTATION)
		.type_attribute("BlockType", SERDE_ANNOTATION)
		.type_attribute("BlockTypeV2", SERDE_ANNOTATION)
		...
		.type_attribute("GetBlockV5ByNumberResponse", SERDE_ANNOTATION)
		...
		.type_attribute("GetLatestBlockHeadersRequestV5", SERDE_ANNOTATION)
		.type_attribute("GetLatestBlockHeadersResponseV5", SERDE_ANNOTATION)
		...
		.type_attribute("BlockHeaderV5", SERDE_ANNOTATION)
